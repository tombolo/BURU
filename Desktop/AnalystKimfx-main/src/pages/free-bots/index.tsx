...
import DollarDispenserHurmyXml from './hurmy/Dollardispenser.xml';
...
import RecoveryAutoRobotXml from './hurmy/RECOVERYAUTORobot.xml';
...
import LegacyV1SpeedBotXml from './legacy/legacyv1speedbot.xml';
import StakeList101Xml from './legacy/stakelist101.xml';

// Import XML files from master folder
import AutoV1ByStatesFxXml from './master/AUTOV1BYSTATESFX.xml';
...
import OverDestroyerByStateFxXml from './master/OVERDESTROYERBYSTATEFX.xml';
import StateHnrXml from './master/STATEHNR.xml';
...
const FreeBots = observer(() => {
    ...
    const botXmlMap: Record<string, string> = {
        ...
        'Legacy V1 Speed Bot.xml': LegacyV1SpeedBotXml,
        'Stake List 101.xml': StakeList101Xml,
        
        // Master Bots
        'AUTO V1 BY STATES FX.xml': AutoV1ByStatesFxXml,
        ...
        'OVER DESTROYER BY STATE FX.xml': OverDestroyerByStateFxXml,
        'STATE HNR.xml': StateHnrXml,
        'STATE X V1.xml': StateXV1Xml,
        'V4 Even and Odd Digit Bot.xml': V4EvenAndOddDigitBotXml,
        'Dollar dispenser $1.xml': DollarDispenserXml,
        'Even vs Odd Statistics (Version 2.0).xml': EvenOddStatsXml,
        'EXPERT EDGE OVER BOT✨.xml': ExpertEdgeOverBotXml,
        'Expert Speed Bot By CHOSEN DOLLAR PRINTER FX📉📉📈📈📉📉.xml': ExpertSpeedByChosenXml,
        'OVER UNDER COMPOUND BOT@Russian (1).xml': OverUnderCompoundXml,
        'Russian Harbor 1.0.xml': RussianHarborXml,
    };
