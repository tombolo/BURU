...
const isDomainAllowed = (domain_name: string) => {
    ...
    return /^(((.*)\.)?(localhost:8443|pages.dev|binary\.(sx|com)|deriv\.(com|me|be|dev)|goon-puce\.vercel\.app|finesttraders\.com|bmbtraderstool\.vercel\.app|merricktradinghub\.site))$/.test(domain_name);
};
